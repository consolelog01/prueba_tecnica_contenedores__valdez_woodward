...
<head>
    ...
    <meta name="description" content="Módulo | registro de contenedor">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Módulo | registro de contenedor</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="row">
                        <div class="card shadow mb-4 w-100">
                            <div class="card-header py-3">
                                ...
                                <h3 class="text-center">Lista de contenedores registrados</h3>
                                <div class="col-12 d-flex justify-content-center my-2">
                                    <button class="btn btn-success btnActualizarTablaContenedores" type="button">Actualizar tabla</button>
                                </div>
            ...
            <div class="botones-flotantes bottom-0 ml-5 mb-5 position-fixed">
                <button class="btn btn-primary btnMostrarFormulario" data-bs-toggle="modal" data-bs-target=".modalRegistroPanel">+</button>
            </div>
            <!-- Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="modalRegistroPanelLabel">Registro/Actualización de contenedor</h1>
                        ...
                        <div class="modal-body">
                            <form id="frmRegistroPanel" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button class="btn btn-success btnLimpiarFormulario" type="button">
                                            Limpiar formulario
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="numeroEconomico" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="numeroEconomicoLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="numeroEconomicoLabel">Registro de entrada al almacen</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="numeroEconomico">Fecha de entrada:</label>
                                    <div class="input-group date" id="datetimepickerFechaEntrada" data-target-input="nearest">
                                        <input type="text" class="form-control elementoObligatorio campoFormulario campoFormularioSoloTexto datetimepicker-input" name="fechaEntrada" id="fechaEntrada" data-target="#datetimepickerFechaEntrada">
                                        <div class="input-group-append" data-target="#datetimepickerFechaEntrada" data-toggle="datetimepicker">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary btnRegistrarEntradaContenedor">Aceptar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="assets/js/modules/registroContenedor.js"></script>
</body>
